...
def create_http_app():
    ...
    routes = [
        ...
        Route("/api/memory/log-relevance", api_memory_log_relevance, methods=["POST"]),
        Route("/api/memory/update", api_memory_update, methods=["POST"]),
        Route("/api/memory/pin", api_memory_pin, methods=["POST"]),
        ...
        Route("/api/memory/conflict/resolve", api_memory_conflict_resolve, methods=["POST"]),
